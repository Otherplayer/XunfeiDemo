...
//    [IFlySetting setLogFilePath:cachePath];
    ...
    NSString *initString = [[NSString alloc] initWithFormat:@"appid=%@,timeout=%@",kIFlySpeechRecognizerAppID,TIMEOUT_VALUE];
...
//    [IFlyFlowerCollector SetAppid:kIFlySpeechRecognizerAppID];
